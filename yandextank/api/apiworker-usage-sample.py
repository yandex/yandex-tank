...
options = dict()
options['config'] = '/home/netort/load.ini'
options['manual_start'] = "1"
options['user_options'] = [
    'phantom.ammofile=/home/netort/ammofile',
    'meta.notify=netort',
    'phantom.rps_schedule=const(1,2m)',
]
log_filename = '/home/netort/tank.log'
#======================================
...
try:
    ...
    logger.error('Error tring to perform a test: %s', ex)
