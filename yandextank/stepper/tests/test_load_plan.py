...
@pytest.mark.parametrize(
    ...
    [('line(1,500,1m30s)', 90), ('const(50,1h30s)', 3630 * 1000), ('step(10,200,10,1h20m)', 4800 * 1000)],
)
...
@pytest.mark.parametrize(
    ...
    [
        ...
        (
            {'uris': ['/case1?sleep=1000', '/case2?sleep=100', '/case3?sleep=10'], 'headers': ['[Connection: close]']},
...
@pytest.mark.parametrize(
    'stepper_kwargs, expected_stpd', [({'uris': ['/', '/foo']}, 'yandextank/stepper/tests/loop1.stpd')]
)
