OPTIONS = {
    ...
    'autocases': {
        ...
        'anyof': [{'type': 'integer'}, {'type': 'string', 'allowed': ['uri', 'uniq']}],
        'default': 0,
        'values_description': {
    ...
    "affinity": {
        ...
        "type": "string",
        "default": '',
        'examples': {'0-3': 'enable first 4 cores', '0,1,2,16,17,18': 'enable 6 specified cores'},
    },
    'ammo_limit': {
    ...
    "buffered_seconds": {"type": "integer", "default": 2, 'description': 'Aggregator latency'},
    'cache_dir': {'type': 'string', 'nullable': True, 'default': None, 'description': 'stpd-file cache directory'},
    'chosen_cases': {'type': 'string', 'default': '', 'description': 'Use only selected cases.'},
    'client_certificate': {'type': 'string', 'default': '', 'description': 'Path to client SSL certificate'},
    'client_cipher_suites': {
        'type': 'string',
        'default': '',
        'description': 'Cipher list, consists of one or more cipher strings separated by colons (see man ciphers)',
    },
    'client_key': {'type': 'string', 'default': '', 'description': 'Path to client\'s certificate\'s private key'},
    'config': {'type': 'string', 'default': '', 'description': 'Use ready phantom config instead of generated'},
    'connection_test': {
        'type': 'boolean',
        'default': True,
        'description': 'Test TCP socket connection before starting the test',
    },
    "enum_ammo": {"type": "boolean", "default": False},
    'file_cache': {'type': 'integer', 'default': 8192},
    'force_stepping': {'type': 'integer', 'default': 0, 'description': 'Ignore cached stpd files, force stepping'},
    'gatling_ip': {'type': 'string', 'default': ''},
    "header_http": {
        "type": "string",
        'default': '1.0',
        'description': 'HTTP version',
        'allowed': ['1.0', '1.1'],
        'values_description': {'1.0': 'http 1.0', '1.1': 'http 1.1'},
    },
    "headers": {
        "type": "list",
        'default': [],
        'description': 'HTTP headers',
        'schema': {'description': 'Format: "Header: Value"', 'type': 'string', 'examples': {'accept: text/html': ''}},
    },
    'instances': {'description': 'Max number of concurrent clients.', 'type': 'integer', 'default': 1000},
    'loop': {'description': 'Loop over ammo file for the given amount of times.', 'type': 'integer', 'default': -1},
    'method_options': {
    ...
    'name': {'description': 'Name of a part in multi config', 'type': 'string', 'required': False},
    'phantom_http_entity': {
        'type': 'string',
        'default': '8M',
        'description': 'Limits the amount of bytes Phantom reads from response.',
    },
    'phantom_http_field': {'type': 'string', 'default': '8K', 'description': 'Header size.'},
    'phantom_http_field_num': {'type': 'integer', 'default': 128, 'description': 'Max number of headers'},
    'phantom_http_line': {'type': 'string', 'default': '1K', 'description': 'First line length'},
    "phantom_modules_path": {"type": "string", "default": "/usr/lib/phantom", 'description': 'Phantom modules path.'},
    "phantom_path": {'description': 'Path to Phantom binary', "type": "string", "default": "phantom"},
    "phout_file": {"type": "string", 'description': 'deprecated', "default": ""},
    'port': {
    ...
    'tank_type': {
        ...
        'default': 'http',
        'allowed': ['http', 'none'],
        'values_description': {'http': 'HTTP gun', 'none': 'TCP gun'},
    },
    "timeout": {'description': 'Response timeout', "type": "string", "default": "11s"},
    "uris": {
        "type": "list",
        'default': [],
        'description': 'URI list',
        'schema': {'type': 'string', 'description': 'URI path string'},
...
MULTI = {
    'multi': {'type': 'list', 'allow_unknown': True, 'schema': {'type': 'dict', 'schema': MULTI_OPTIONS}, 'default': []}
}
