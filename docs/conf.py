...
latex_documents = [
    ('index', 'YandexTank.tex', u'Yandex.Tank Documentation', u'Yandex', 'manual'),
]
...
man_pages = [('index', 'yandextank', u'Yandex.Tank Documentation', [u'Yandex'], 1)]
