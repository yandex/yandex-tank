...
if __name__ == "__main__":
    ...
    parser.add_option('-i', '--ignore-lock', action='store_true', dest='ignore_lock',
                      help="Ignore lock files from concurrent instances, has precedence before --lock-fail")
    parser.add_option('-f', '--fail-lock', action='store_true', dest='lock_fail',
    ...
    parser.add_option('-m', '--manual-start', action='store_true', dest='manual_start',
                      help="Wait for Enter key to start the test")
    parser.add_option('-n', '--no-rc', action='store_true', dest='no_rc',
    ...
    parser.add_option('-s', '--scheduled-start', action='store', dest='scheduled_start',
